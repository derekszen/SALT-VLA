...
## Model downloads
- The VideoMAE-H teacher and CLIP text encoder are pulled automatically from Hugging Face on first run.
- Expect the first teacher test or cache build to download model weights.
