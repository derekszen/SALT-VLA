#!/usr/bin/env python3
"""ViT-Base Experiment 3: Combined - Higher LR + Higher Mask

Hypothesis: Combining higher LR with harder task may yield best results.

Changes:
- lr: 1.5e-4 → 3e-4 (2x)
- mask_ratio: 0.75 → 0.9 (more aggressive)
